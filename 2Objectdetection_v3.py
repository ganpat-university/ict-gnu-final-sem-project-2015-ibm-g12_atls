...
#                         font,1,colors[classId-1],2)
            ...
            data_dict={"Date Time":datetime.now(),"Vehicles Detected":classIds,"Accuracy":confidence}
            print(classNames[classIds[i]-1]+" "+confidence,datetime.now())
            data_list.append({"Date Time":datetime.now(),"Vehicles Detected":classIds,"Accuracy":confidence})
